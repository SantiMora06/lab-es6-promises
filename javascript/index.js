  ...
  getInstruction("mashedPotatoes", 2, (step3) => {
    ...
    getInstruction("mashedPotatoes", 3, (step4) => {
      ...
      getInstruction("mashedPotatoes", 4, (step5) => {
       ...
       if (document.querySelector("#mashedPotatoes").innerHTML += `<li>"Mashed potatoes are ready!"</li>`){
        potatoeImg.hidden = false;
       }
...
obtainInstruction('steak', 0)
  ...
  .finally(() => {
    ...
    return document.querySelector("#steak").innerHTML += `<li>Stake is ready!</li>`
  })
...
const makeBroccoli = async () => {
  try {
    ...
    document.querySelector("#broccoli").innerHTML += 
    `<li>${step6}</li>`
    return document.querySelector("#broccoli").innerHTML += 
    `<li>Broccoli is ready!</li>`, broccoliImg.hidden = false;
